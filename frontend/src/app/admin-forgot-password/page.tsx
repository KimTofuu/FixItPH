  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <p className={styles.lead}>Enter your admin email to receive a password reset link.</p>
        ...
        <form onSubmit={handleSubmit} className={styles.form} autoComplete="off">
          <label className={styles.label}>
            ...
            <input
              ...
              aria-describedby="helper-text-admin"
            />
          </label>
        ...
        <p id="helper-text-admin" className={styles.helper}>
